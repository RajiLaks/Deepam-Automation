...
test.describe('Helpdesk History', async()=>{
 
    test.beforeAll('History Module', async({browser})=>{
...
test("TC004 - Verify View Box opens and closes correctly under Actions column", async () => {    
