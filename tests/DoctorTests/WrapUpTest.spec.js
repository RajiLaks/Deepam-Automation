...
const {WrapUp} = require ('../../Pages/DoctorPage/WrapUpPage');
...
test.describe('TS01', async()=>{
    ...
    test('TC002 - Verify that the Wrapup screen displays the appointment data', async()=>{
        const wrapup = new WrapUp(page);
        await wrapup.WrapupFlow();
    })
})